...
std_msgs::Float32MultiArray forcedata;

ros::Publisher pub("sensor", &forcedata);
...
void setup()
{
  ...
  forcedata.data = (float*)malloc(sizeof(float)*5);
  
  forcedata.data_length = 5;
}
...
void loop()
{
   ...
   for (int i=0; i<5; i++)
  {
   ...
   forcedata.data[i]=value;
 }
  


  pub.publish( &forcedata );
